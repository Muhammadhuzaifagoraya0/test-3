        ...
        <ul className="flex flex-wrap justify-center gap-2 md:gap-3">
          {socials.map((s) => (
            <li key={s}>
              <a
                href="#"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-white text-[12px] font-bold text-white transition-colors duration-150 hover:bg-white hover:text-brand md:h-[60px] md:w-[60px] md:text-[16px]"
              >
                {s}
              </a>
            </li>
